...
const DashboardMockup = () => {
  ...
  const dailyCallData = [
    ...
    { hour: '11:00', '5/28': 13, '5/29': 18, '5/30': 15, '5/31': 16, '6/1': 16 },
    { hour: '12:00', '5/28': 10, '5/29': 11, '5/30': 10, '5/31': 12, '6/1': 11 },
    { hour: '13:00', '5/28': 12, '5/29': 13, '5/30': 11, '5/31': 14, '6/1': 13 },
    { hour: '14:00', '5/28': 15, '5/29': 17, '5/30': 15, '5/31': 18, '6/1': 17 },
  ...
  return (
    <div className="bg-gray-100 p-6 font-sans">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="flex items-center">
            ...
            <div className="relative inline-block w-12 align-middle select-none">
              <input type="checkbox" name="toggle" id="toggle" className="absolute block w-6 h-6 bg-white rounded-full border-4 appearance-none cursor-pointer focus:outline-none checked:right-0 checked:border-green-500 transition-all duration-200 ease-in-out" defaultChecked />
              <label htmlFor="toggle" className="block h-6 overflow-hidden bg-gray-300 rounded-full cursor-pointer checked:bg-green-500">
      ...
      <div className="grid grid-cols-6 gap-4 mb-6">
        ...
        <div className="bg-white p-4 rounded shadow">
          <h2 className="text-sm font-semibold text-gray-500">9秒以上待たされた</h2>
      ...
      <div className="grid grid-cols-2 gap-6 mb-6">
        {/* 左側: 一週間の受電状況 */}
        <div className="bg-white p-4 rounded shadow">
          <h2 className="text-lg font-semibold mb-4">直近5日間の1時間ごとの受電状況</h2>
            ...
            <div className="h-80">
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <Line type="monotone" dataKey="5/28" stroke="#10B981" strokeWidth={2} dot={false} name="5/28" />
                  <Line type="monotone" dataKey="5/29" stroke="#FBBF24" strokeWidth={2} dot={false} name="5/29" />
                  <Line type="monotone" dataKey="5/30" stroke="#8B5CF6" strokeWidth={2} dot={false} name="5/30" />
                  <Line type="monotone" dataKey="5/31" stroke="#EF4444" strokeWidth={2} dot={false} name="5/31" />
                  <Line type="monotone" dataKey="6/1" stroke="#3B82F6" strokeWidth={2} dot={false} name="6/1" />
                </LineChart>
              </ResponsiveContainer>
            </div>
          </div>
            ...
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <YAxis hide={true} />
                  <Tooltip content={<CustomTooltip />} />
                  <Area type="monotone" dataKey="count" stroke="#3B82F6" fillOpacity={1} fill="url(#colorCount)" name="着信数" />
                </AreaChart>
              </ResponsiveContainer>
            </div>
          </div>
      ...
      <div className="grid grid-cols-2 gap-6 mb-6">
              ...
              <table className="min-w-full">
                ...
                <tbody className="text-sm">
                  <tr>
                    ...
                    <td className="py-1"><span className="bg-yellow-100 text-yellow-800 px-2 py-0.5 rounded-full text-xs">休憩中</span></td>
                  </tr>
                  <tr>
                    <td className="py-1">鈴木 一郎</td>
                    <td className="py-1">12:10</td>
                    <td className="py-1"><span className="bg-green-100 text-green-800 px-2 py-0.5 rounded-full text-xs">待機中</span></td>
                  </tr>
                  <tr>
        ...
        {/* 右側: 注意が必要なオペレーター */}
        <div className="bg-white p-4 rounded shadow">
          <h2 className="text-lg font-semibold mb-4">注意が必要なオペレーター</h2>
          <div className="border-t border-gray-200 pt-3">
            <div className="max-h-32 overflow-auto">
              <table className="min-w-full">
                <thead>
                ...
                <tbody className="text-sm">
                  <tr>
                    ...
                    <td className="py-1"><span className="bg-red-100 text-red-800 px-2 py-0.5 rounded-full text-xs">要対応</span></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td className="py-1"><span className="bg-yellow-100 text-yellow-800 px-2 py-0.5 rounded-full text-xs">監視中</span></td>
                  </tr>
                </tbody>
              </table>
            </div>
      ...
      <div className="grid grid-cols-2 gap-6">
        {/* 左: 対応時間が15分以上のタスク */}
        <div className="bg-white p-4 rounded shadow">
          <h2 className="text-lg font-semibold mb-4">対応時間が15分以上のタスク</h2>
          <div className="border-t border-gray-200 pt-3">
              ...
              <table className="min-w-full">
                ...
                <tbody className="text-sm">
                  <tr>
                    ...
                    <td className="py-1 text-red-600 font-semibold">1時間7分</td>
                  </tr>
                  <tr>
